    ...
    */
    ...
    protected Ifactor multGcdLcm( final Ifactor oth , int type ){
        ...
        if( primeexp.size() != 0 && oth.primeexp.size() != 0 ){
                        ...
                        */
            if( primeexp.firstElement().intValue() == 1 && type == 0 ) return oth;
            else if( primeexp.firstElement().intValue() == 1 && type == 2 ) return oth;
            else if( primeexp.firstElement().intValue() == 1 && type == 1 ) return this;
            else if( oth.primeexp.firstElement().intValue() == 1 && type == 0 ) return this;
            else if( oth.primeexp.firstElement().intValue() == 1 && type == 2 ) return this;
            else if( oth.primeexp.firstElement().intValue() == 1 && type == 1 ) return oth;
            else{
                int idxThis = 0;
                int idxOth  = 0;
                switch( type ){
    ...
    public Ifactor pow( final int exponent ) throws ArithmeticException{
                ...
                */
        if( exponent < 0 ) throw new ArithmeticException( "Cannot raise " + toString() + " to negative " + exponent );
    ...
    public Rational root( final int r ) throws ArithmeticException{
        if( r == 0 ) throw new ArithmeticException( "Cannot pull zeroth root of " + toString() );
        else if( r < 0 ){
                        /* a^(-1/b)= 1/(a^(1/b))
                        */
            ...
            for( int i = 0 ; i < primeexp.size() ; i += 2 ){
                                ...
                                */
                int ex = primeexp.elementAt( i + 1 ).intValue();
                if( ex % r != 0 ) throw new ArithmeticException( "Cannot pull " + r + "th root of " + toString() );
    ...
    public boolean issquare(){
        ...
        for( int i = 1 ; i < primeexp.size() ; i += 2 ){
            if( primeexp.elementAt( i ).intValue() % 2 != 0 ) return false;
        }
        return true;
    } /* Ifactor.issquare */
        ...
        if( n.compareTo( BigInteger.ONE ) == 0 ) resul.append( "1" );
            ...
            for( int i = 0 ; i < primeexp.size() ; i += 2 ){
                ...
                if( primeexp.elementAt( i + 1 ) > 1 )
                    resul.append( primeexp.elementAt( i ).toString() ).append( "^" ).append(
