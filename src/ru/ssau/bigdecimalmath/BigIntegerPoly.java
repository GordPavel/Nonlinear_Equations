...
public class BigIntegerPoly implements Cloneable{
    ...
    public BigInteger valueOf( final BigInteger x ){
        if( a.size() == 0 ) return BigInteger.ZERO;
    ...
    public String toString(){
        ...
        for( int n = 0 ; n < a.size() ; n++ ){
            if( n == 0 ) str += a.elementAt( n ).toString();
            else str += "," + a.elementAt( n ).toString();
        }
    ...
    public String toPString(){
        ...
        for( int n = 0 ; n < a.size() ; n++ ){
            ...
            if( num.compareTo( BigInteger.ZERO ) != 0 ){
                str += " ";
                if( num.compareTo( BigInteger.ZERO ) > 0 && n > 0 ) str += "+";
                    ...
                    if( bco.signum() != 0 ){
                        for( int sig = -1 ; sig <= 1 ; sig += 2 ){
                            BigInteger bcosig = ( sig > 0 ) ? bco : bco.negate();
                                                ...
                                                */
                            BigDecimal negA = BigDecimalMath.add( BigDecimalMath.divideRound( bcosig , z.norm() ) ,
                                                                  cco );
